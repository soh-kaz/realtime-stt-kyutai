...
async def get_demo_page():
    ...
    <body>
        <div class="container">
            <h1>🎙️ Kyutai STT Streaming</h1>
            
            <div class="controls">
                <button id="permissionBtn" class="permission-btn">🔐 Check Microphone Permission</button>
                <button id="startBtn" class="start-btn">🎤 Start Recording</button>
                <button id="stopBtn" class="stop-btn" disabled>🛑 Stop Recording</button>
                <button id="clearBtn" class="clear-btn">🗑️ Clear Text</button>
            </div>
            
            <div id="permissionStatus" class="permission-check" style="display: none;">
                <div>🎙️ Microphone permission is required for speech recognition</div>
            ...
            class STTStreaming {
                ...
                handlePermissionStatus(state) {
                    if (state === 'granted') {
                        ...
                        this.permissionBtn.textContent = '✅ Microphone Permission Granted';
                        this.permissionBtn.style.background = 'linear-gradient(45deg, #4CAF50, #45a049)';
                        this.permissionBtn.style.color = 'white';
                    } else if (state === 'denied') {
                        this.permissionStatus.style.display = 'block';
                        this.startBtn.disabled = true;
                        this.permissionBtn.textContent = '❌ Microphone Permission Denied';
